...
if (!window.findpwInjected) {
    window.findpwInjected = true;
    ...
    async function sendpageinfoRest(cpi, clicked, onload) {
        ...
        let response = {};
        try {
            if (logging) console.log(document.URL, Date.now() - start, "findpw sendpageinfo", document.location.hostname, cpi.pwfields.length, clicked, onload);
